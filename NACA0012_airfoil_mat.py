...
part_L='NACA0012_L'
# Upper Part
mdb.models['Model-1'].parts[part_U].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=Region(
    cells=mdb.models['Model-1'].parts[part_U].cells), sectionName=material, 
    thicknessAssignment=FROM_SECTION)
# Lower Parte
mdb.models['Model-1'].parts[part_L].SectionAssignment(offset=0.0, 
    offsetField='', offsetType=MIDDLE_SURFACE, region=Region(
    cells=mdb.models['Model-1'].parts[part_L].cells), sectionName=material, 
    thicknessAssignment=FROM_SECTION)
#====================================================== SAVE .cae FILE =======================================================================
mdb.saveAs(
    pathName='C:/Users/mario/Documents/T\xc9CNICO/5\xba ANO- 2\xba Semestre/TESE/C\xd3DIGO/ANACONDA/abaqus_testing/NACA0012_analysis.cae')